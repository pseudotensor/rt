...
typedef struct  
{
  int (* function) (doub t, const doub y[], doub dydt[], void * params);
  int (* jacobian) (doub t, const doub y[], doub * dfdy, doub dfdt[], void * params);
  size_t dimension;
  void * params;
}
gsl_odeiv_system;
...
typedef struct 
{
  ...
  int  (*apply)  (void * state, size_t dim, doub t, doub h, doub y[], doub yerr[], const doub dydt_in[], doub dydt_out[], const gsl_odeiv_system * dydt);
...
int  gsl_odeiv_step_apply(gsl_odeiv_step * s, doub t, doub h, doub y[], doub yerr[], const doub dydt_in[], doub dydt_out[], const gsl_odeiv_system * dydt);
...
typedef struct 
{
  const char * name;
  void * (*alloc) (void);
  int  (*init) (void * state, doub eps_abs, doub eps_rel, doub a_y, doub a_dydt);
  int  (*hadjust) (void * state, size_t dim, unsigned int ord, const doub y[], const doub yerr[], const doub yp[], doub * h);
  void (*free) (void * state);
}
...
int gsl_odeiv_control_init(gsl_odeiv_control * c, doub eps_abs, doub eps_rel, doub a_y, doub a_dydt);
void gsl_odeiv_control_free(gsl_odeiv_control * c);
int gsl_odeiv_control_hadjust (gsl_odeiv_control * c, gsl_odeiv_step * s, const doub y[], const doub yerr[], const doub dydt[], doub * h);
...
gsl_odeiv_control * gsl_odeiv_control_standard_new(doub eps_abs, doub eps_rel, doub a_y, doub a_dydt);
gsl_odeiv_control * gsl_odeiv_control_y_new(doub eps_abs, doub eps_rel);
gsl_odeiv_control * gsl_odeiv_control_yp_new(doub eps_abs, doub eps_rel);
 ...
 */
gsl_odeiv_control * gsl_odeiv_control_scaled_new(doub eps_abs, doub eps_rel, doub a_y, doub a_dydt, const doub scale_abs[], size_t dim);
...
int gsl_odeiv_evolve_apply(gsl_odeiv_evolve * e, gsl_odeiv_control * con, gsl_odeiv_step * step, const gsl_odeiv_system * dydt, doub * t, doub t1, doub * h, doub y[]);
