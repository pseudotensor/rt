...
\author{Roman Gold}
\email{gold@umd.edu}
\affil{Department of Physics, University of Maryland, College Park, MD 20742-2421, USA \\JSI Scientist, Postdoctoral Research Associate}
\email{gold@umd.edu}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}
\includegraphics[width=0.48\textwidth]{callgraph.png}
...
\newpage %% This was needed at some point to avoid the text from being cut and bib to be colored like \rg{}
