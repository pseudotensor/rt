...
for snapshot in `seq 6100 1 6199`; do
  for case in `seq 100 1 100`; do

    upper_left_panel=shotimag93.75th140f230fn$snapshot\_299_IQUV_xy.png
    upper_right_panel=shotimag93.75th140f230fn$snapshot\_299_I-LP-EVPA-CP_xy.png
    lower_left_panel=shotimag93.75th140f230fn$snapshot\_299_IQUV_uv.png
    lower_right_panel=shotimag93.75th140f230fn$snapshot\_299_4panel_uv.png
