...
//geodesic solver, code is autogenerated in Wolfram Mathematica (see corresponding section in checks_GRMHD_code.nb file)
...
doub rsq=y[4]*y[4], 
     ...
     // RG: WHY 2. ? I thought we use the Schwarzschild radius
     dx=rasq-2.*y[4], // =Delta ? see http://dx.doi.org/10.4236/jmp.2012.312237 
     sinmusq=sinmu*sinmu;
...
doub gg001=(rasq*rhogmin)/(dx*rhosqsq), 
  ...
  gg212=y[4]/rhosq, // agrees with http://dx.doi.org/10.4236/jmp.2012.312237 
  gg222=-((asq*sinmu*y[5])/rhosq), // gg222=g112 in agreement with http://dx.doi.org/10.4236/jmp.2012.312237 
	 gg233=-((sinmu*y[5]*(2.*y[4]*rasq*rasq+dx*rhosqsq))/(rhosqsq*rhosq)),
	 gg301=(a*rhogmin)/(dx*rhosqsq),
  gg302=(-2.*a*y[4]*y[5])/(sinmu*rhosqsq), // agrees with http://dx.doi.org/10.4236/jmp.2012.312237 
...
// f[6] ~> t'
// t'=-2rt*gg001+2mut*gg002/sinmu-2rphi*gg013+2muphi*gg023/sinmu
