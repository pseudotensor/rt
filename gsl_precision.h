 ...
 */
GSL_VAR const doub gsl_prec_eps[];
GSL_VAR const doub gsl_prec_sqrt_eps[];
GSL_VAR const doub gsl_prec_root3_eps[];
GSL_VAR const doub gsl_prec_root4_eps[];
GSL_VAR const doub gsl_prec_root5_eps[];
GSL_VAR const doub gsl_prec_root6_eps[];
