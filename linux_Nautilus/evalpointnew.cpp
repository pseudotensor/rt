...
doub iKS[4][4], iMKS[4][4], MKStoKS[4][4], e1BL[4],e2xx[4],kBL[4],/*kup[4],e1up[4],x2frac,x2temp,lr, lrfrac,x2,*/ly[4], rest[11], tet, tpt, Bup[4],Bi[4],u[4],uKS[4],uloKS[4],ulo[4],
	kupKS[4],e1upKS[4],BupKS[4],rho,sc[4];
...
doub Tx,Tz=rest[1];ia=0;ib=indT;ix;
if((Ta<=Tz) && (Tz<=Tb)){
