...
static const doub ah[] = { 1.0/4.0, 3.0/8.0, 12.0/13.0, 1.0, 1.0/2.0 };
static const doub b3[] = { 3.0/32.0, 9.0/32.0 };
static const doub b4[] = { 1932.0/2197.0, -7200.0/2197.0, 7296.0/2197.0};
static const doub b5[] = { 8341.0/4104.0, -32832.0/4104.0, 29440.0/4104.0, -845.0/4104.0};
static const doub b6[] = { -6080.0/20520.0, 41040.0/20520.0, -28352.0/20520.0, 9295.0/20520.0, -5643.0/20520.0};

static const doub c1 = 902880.0/7618050.0;
static const doub c3 = 3953664.0/7618050.0;
static const doub c4 = 3855735.0/7618050.0;
static const doub c5 = -1371249.0/7618050.0;
static const doub c6 = 277020.0/7618050.0;

/* These are the differences of fifth and fourth order coefficients
   for error estimation */

static const doub ec[] = { 0.0,
  1.0 / 360.0,
  0.0,
  -128.0 / 4275.0,
  -2197.0 / 75240.0,
...
rkf45_alloc (size_t dim)
{
  ...
  state->k4 = (doub *) malloc (dim * sizeof (doub));
  ...
  state->k5 = (doub *) malloc (dim * sizeof (doub));
  ...
  state->k6 = (doub *) malloc (dim * sizeof (doub));
  ...
  state->y0 = (doub *) malloc (dim * sizeof (doub));
...
rkf45_apply (void *vstate,
            ...
            doub yerr[],
            const doub dydt_in[],
            doub dydt_out[], const gsl_odeiv_system * sys)
{
  ...
  doub *const k4 = state->k4;
  doub *const k5 = state->k5;
  doub *const k6 = state->k6;
  doub *const ytmp = state->ytmp;
  doub *const y0 = state->y0;
  ...
  for (i = 0; i < dim; i++)
    {
      const doub d_i = c1 * k1[i] + c3 * k3[i] + c4 * k4[i] + c5 * k5[i] + c6 * k6[i];
      y[i] += h * d_i;
    }
