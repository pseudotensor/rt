...
/*doub gsl_linalg_householder_transform (gsl_vector * v);
gsl_complex gsl_linalg_complex_householder_transform (gsl_vector_complex * v);

int gsl_linalg_householder_hm (doub tau, 
                               const gsl_vector * v, 
                               gsl_matrix * A);

int gsl_linalg_householder_mh (doub tau, 
                               const gsl_vector * v, 
                               gsl_matrix * A);

int gsl_linalg_householder_hv (doub tau, 
                               const gsl_vector * v, 
                               gsl_vector * w);

int gsl_linalg_householder_hm1 (doub tau, 
                                gsl_matrix * A);
...
doub gsl_linalg_LU_det (gsl_matrix * LU, int signum);
doub gsl_linalg_LU_lndet (gsl_matrix * LU);
...
doub gsl_linalg_complex_LU_lndet (gsl_matrix_complex * LU);
