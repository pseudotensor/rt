...
int
gsl_spline_init(gsl_spline * spline, const doub xa[], const doub ya[], size_t size);
...
int
gsl_spline_eval_e(const gsl_spline * spline, doub x,
                  gsl_interp_accel * a, doub * y);

doub
gsl_spline_eval(const gsl_spline * spline, doub x, gsl_interp_accel * a);
