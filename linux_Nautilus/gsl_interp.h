...
typedef struct {
  ...
  int     (*init)    (void *, const doub xa[], const doub ya[], size_t size);
  int     (*eval)    (const void *, const doub xa[], const doub ya[], size_t size, doub x, gsl_interp_accel *, doub * y);
  int     (*eval_deriv)  (const void *, const doub xa[], const doub ya[], size_t size, doub x, gsl_interp_accel *, doub * y_p);
  int     (*eval_deriv2) (const void *, const doub xa[], const doub ya[], size_t size, doub x, gsl_interp_accel *, doub * y_pp);
  int     (*eval_integ)  (const void *, const doub xa[], const doub ya[], size_t size, gsl_interp_accel *, doub a, doub b, doub * result);
  void    (*free)         (void *);
...
int
gsl_interp_init(gsl_interp * obj, const doub xa[], const doub ya[], size_t size);
...
gsl_interp_eval_e(const gsl_interp * obj,
                  const doub xa[], const doub ya[], doub x,
                  gsl_interp_accel * a, doub * y);
...
INLINE_DECL size_t
gsl_interp_bsearch(const doub x_array[], doub x,
...
INLINE_DECL size_t 
gsl_interp_accel_find(gsl_interp_accel * a, const doub x_array[], size_t size, doub x);

#ifdef HAVE_INLINE
INLINE_FUN size_t
gsl_interp_accel_find(gsl_interp_accel * a, const doub xa[], size_t len, doub x)
{
