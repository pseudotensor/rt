...
{
  doub (* function) (doub x, void * params);
  void * params;
};
...
{
  doub (* f) (doub x, void * params);
  doub (* df) (doub x, void * params);
  void (* fdf) (doub x, void * params, doub * f, doub * df);
  void * params;
};
...
{
  int (* function) (doub x, doub y[], void * params);
  void * params;
};
