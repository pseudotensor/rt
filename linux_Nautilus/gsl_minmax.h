...
doub gsl_max (doub a, doub b);
doub gsl_min (doub a, doub b);
...
INLINE_FUN doub GSL_MAX_DBL (doub a, doub b);
INLINE_FUN doub GSL_MIN_DBL (doub a, doub b);
...
INLINE_FUN doub
GSL_MAX_DBL (doub a, doub b)
{
  return GSL_MAX (a, b);
}

INLINE_FUN doub
GSL_MIN_DBL (doub a, doub b)
{
  return GSL_MIN (a, b);
}
