  ...
  size_t N)
{
  ...
  doub *gamma = (doub *) malloc (N * sizeof (doub));
  doub *alpha = (doub *) malloc (N * sizeof (doub));
  doub *c = (doub *) malloc (N * sizeof (doub));
  doub *z = (doub *) malloc (N * sizeof (doub));
  ...
  size_t N)
{
  ...
  if (alpha == 0 || z == 0)
  ...
  else
    {
      ...
      for (i = 1; i < N; i++)
        {
          const doub t = belowdiag[b_stride*(i - 1)]/alpha[i-1];
...
{
  int status = GSL_SUCCESS;
  doub * delta = (doub *) malloc (N * sizeof (doub));
  doub * gamma = (doub *) malloc (N * sizeof (doub));
  doub * alpha = (doub *) malloc (N * sizeof (doub));
  doub * c = (doub *) malloc (N * sizeof (doub));
  doub * z = (doub *) malloc (N * sizeof (doub));
  ...
  size_t N)
{
  int status = GSL_SUCCESS;
  doub *alpha = (doub *) malloc (N * sizeof (doub));
  doub *zb = (doub *) malloc (N * sizeof (doub));
  doub *zu = (doub *) malloc (N * sizeof (doub));
  doub *w = (doub *) malloc (N * sizeof (doub));
  ...
  if (alpha == 0 || zb == 0 || zu == 0 || w == 0)
  ...
  else
    {
      ...
      {
        const doub q = 1 - abovediag[0]*belowdiag[0]/(diag[0]*diag[d_stride]);
      ...
      /* Sherman-Morrison */
      {
        const doub vw = w[0] + belowdiag[b_stride*(N - 1)]/beta * w[N-1];
        const doub vx = x[0] + belowdiag[b_stride*(N - 1)]/beta * x[x_stride*(N - 1)];
        /* FIXME!!! */
        if (vw + 1 == 0) {
          status = GSL_EZERODIV;
        }
