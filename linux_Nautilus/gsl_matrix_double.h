...
_gsl_matrix_view
gsl_matrix_view_array (doub * base,
                             const size_t n1, 
                             const size_t n2);

_gsl_matrix_view
gsl_matrix_view_array_with_tda (doub * base, 
                                      const size_t n1, 
                                      const size_t n2,
                                      const size_t tda);
...
_gsl_matrix_const_view
gsl_matrix_const_view_array (const doub * base,
                                   const size_t n1, 
                                   const size_t n2);

_gsl_matrix_const_view
gsl_matrix_const_view_array_with_tda (const doub * base, 
                                            const size_t n1, 
                                            const size_t n2,
                                            const size_t tda);
...
void gsl_matrix_set_all (gsl_matrix * m, doub x);
...
doub gsl_matrix_max (const gsl_matrix * m);
doub gsl_matrix_min (const gsl_matrix * m);
void gsl_matrix_minmax (const gsl_matrix * m, doub * min_out, doub * max_out);
...
int gsl_matrix_scale (gsl_matrix * a, const doub x);
int gsl_matrix_add_constant (gsl_matrix * a, const doub x);
int gsl_matrix_add_diagonal (gsl_matrix * a, const doub x);
...
INLINE_DECL doub   gsl_matrix_get(const gsl_matrix * m, const size_t i, const size_t j);
INLINE_DECL void    gsl_matrix_set(gsl_matrix * m, const size_t i, const size_t j, const doub x);
INLINE_DECL doub * gsl_matrix_ptr(gsl_matrix * m, const size_t i, const size_t j);
INLINE_DECL const doub * gsl_matrix_const_ptr(const gsl_matrix * m, const size_t i, const size_t j);
...
INLINE_FUN 
void
gsl_matrix_set(gsl_matrix * m, const size_t i, const size_t j, const doub x)
{
#if GSL_RANGE_CHECK
  if (GSL_RANGE_COND(1)) 
    {
...
#endif
  return (const doub *) (m->data + (i * m->tda + j)) ;
} 
